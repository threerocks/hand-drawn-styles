...
> 纯风格。比例:不传则不注入。占位符 `【主体】【构图】【文字】` 自动推断,【构图】默认"单人或双人半身立绘,视线亲和"。
>
> 命门:**配色三件套**——奶油暖底晕染(人物头部四周最亮、绝不留冷白背景)+ 橙蓝互补结构(暖色主导+唯一钴蓝锚点)+ 玫瑰腮红暖肤——这三样是亲和力的全部来源,丢一样就泄气。**概念稿身份件**:轮廓外露铅笔起稿线、旁边一两笔试色色块、下缘干刷渐散融进纸白。
> 最常踩的坑:①画成"标准美人脸"(必须要求动画角色设计的夸张取舍)②背景加环境细节(舞台光即全部)③钴蓝锚点丢失变成单调暖色画④画得太满丢掉未完成感。
> 出身:1950s 美式中古动画(Disney/UPA 血统)概念设定稿;天然适配 i2v 动画产线(角色立绘即动画锚图)。多角色跨张一致性靠写死发型+服色。

```
一张1950年代美式中古动画概念设定稿风格的角色插画(mid-century Disney/UPA 血统的角色概念画),数字水粉厚涂,不是3D渲染、不是矢量插画、不是照片。
主体:【主体】。
笔触(最重要):松散可见的水粉/干刷笔触,色块边缘毛化不封闭,厚涂颜料有干湿浓淡变化;轮廓外围隐约保留铅笔起稿线,画面一角留一两笔试色色块;画面下缘与外缘笔触渐散、干刷扫开融进纸白,保留概念稿的未完成感。
角色设计:动画角色设计而非写实美人——五官比例有戏剧化取舍、脸型有设计感(长脸配细脖或圆脸配短脖的对比),大眼睛带椭圆形高光,眉弓表情生动,必有玫瑰色腮红和暖肤色高光,宁可有个性不要标准漂亮脸。
背景:奶油米黄暖色晕染,人物头部四周最亮、向画面边缘渐收并融进纸白,无任何环境细节,画面自带舞台光。
配色(硬纪律):奶油暖底 + 杏橙/金黄暖色主导 + 唯一一处钴蓝/群青冷色锚点(橙蓝互补结构),深色头发或深色衣物做明度锚点;全画色相不超过3族(暖族/蓝族/中性),饱和但不艳俗。
构图:【构图】。
严禁:3D渲染感、干净矢量线条、均匀平涂、照片写实感、环境细节、冷白背景、艳俗高饱和、日系动漫脸。
文字:【文字】
```
