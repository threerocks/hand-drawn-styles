...
>
> 视觉真源:`assets/style-1.2/anchor-family.png`。正式生产、连续故事或多页作品必须把这张图作为**纯画风参考**随每一张请求一起传入;只参考线条、五官、人物比例、蜡笔填色、留白和纸面,不得复制参考图中的家庭成员、站位、衣服或情节。参考图不可用时停止正式生产,不能改用业务项目自己的画风段落补救。
>
> 和 #1 / #1.1 的区别:#1 偏粗黑涂色页与纸面实拍,#1.1 偏低饱和四色克制;1.2 是明亮白底、普通大人歪线稿、孩子稀疏蜡笔填色的亲子投稿故事卡。人物可辨认但不精致,不是孩子从零画的火柴娃,也不是商业绘本萌娃。
>
> 命门:①脸必须锁成小竖椭圆黑点眼 + 小折线鼻 + 小弯线嘴 + 珊瑚红圆形乱涂腮红;②成人与孩子保持可辨认的高矮和身体比例,只轻微大头,绝不 Q 版巨头;③轮廓是细到中等粗的普通黑笔歪线,不能变成统一粗黑马克笔;④衣服和头发保留大片露白与明显越界;⑤背景接近纯白且极简,不做纸张摄影、褶皱、阴影或完整室内布景。
>
> `【文字】` 填法:要标题就写“画面顶部的大片留白区写手写中文标题,逐字为……;字像普通家长用粗黑笔写的,大小略不齐但准确清楚”;不要就写“不加任何文字”。

```
把随请求附带的参考图只当作画风锚点:只继承它的线条、五官、人物比例、蜡笔填色、留白和白底气质;不要复制参考图里的人物身份、服装、站位或情节。
...
人物比例:成年人明显高于孩子,身体是略笨的长方块或简单筒形,四肢简化但动作清楚;孩子明显更矮,头只比成人相对大一点。手可以是圆钝小钩或短线,脚是扁扁的小黑鞋。允许肩膀高低不齐、左右不对称和关节连接不准,但禁止 Q 版大头、圆脸萌娃、火柴四肢、写实人体、精细手指和职业插画式动态。

脸部身份锁(每个人都必须遵守):两只很小的竖椭圆黑点眼,位置可略不齐;小小的折线或弯钩鼻;一条很短的小弯线嘴;两团珊瑚红/粉红蜡笔乱涂的圆腮红。禁止眼白、虹膜、高光、大眼睛、睫毛、精致眉毛、写实眼睑、立体鼻梁、丰润嘴唇、渐变肤色和喷绘腮红。

线稿:普通大人用黑色蜡笔或勾线笔徒手画的细到中等粗轮廓,粗细和压力不均,边线会轻微抖动、歪斜、断开、出头,局部来回描 2-4 遍。线条数量少,没有工整闭合、统一线宽、矢量圆角或粗重卡通描边;头发是几簇直接的黑色乱线,不是顺滑发型块。

填色:像 5-8 岁孩子拿蜡笔随手涂进大人线稿。每个衣服、裤子、头发等主要色块都有乱方向的短笔画、深线浅线、断续和轻重变化;至少一个主色块保留约 25%-40% 明显白底,至少 2-3 个主色块有 1-5mm 一眼可见的涂出边界。肤色只是很淡、稀疏的桃色乱涂,仍保留白底;禁止整齐铺满、统一噪点、柔滑混色、阴影、渐变或体积光。

配色:明快但不荧光的普通蜡笔基础色。单个人物通常只用 1-2 个衣着主色;多人家庭场景全画可以自然出现约 5-7 种颜色,例如橙棕、天蓝、草绿、粉红、芥末黄、灰色和浅桃肤色。不要强行压成四种颜色,不要每个人彩虹配色,不要低饱和灰雾滤镜。

整体判断:第一眼像普通家长画了略歪的黑线稿,再由孩子认真但没涂好的家庭投稿;有温度、有笨拙的小错误、人物有灵魂,但内容与动作一眼能看懂。绝不精修、绝不规整、绝不商业萌化。
