...
>
> 3.1 现行定义是明亮白底、普通大人歪线稿、孩子潦草蜡笔涂抹的家庭投稿画。人物可辨认但不精致,不是火柴娃,也不是商业绘本萌娃。旧 3.1 的“孩子从零画整张火柴娃”配方已经删除,不得再按旧定义调用。
>
> 命门:①脸锁成小竖椭圆黑点眼 + 小折线鼻 + 极短歪线嘴 + 珊瑚红圆形乱涂腮红,但嘴形和五官高低必须随情绪自然变化,不能人人复制同一张笑脸;②成人与孩子保持可辨认的高矮和身体比例,只轻微大头,绝不 Q 版巨头;③轮廓是细到中等粗的普通黑笔歪线,不能变成统一粗黑马克笔;④蜡笔涂抹必须在同一色块里多次停笔、换向、交叉、重压和漏涂,不能退化成单向平行斜线或统一蜡笔滤镜;⑤衣服和头发保留不规则大片露白与偶发越界,不能按统一比例机械执行;⑥同页人物不得复用同一头型、同一肩宽和同一身体骨架;⑦背景接近纯白且极简,不做纸张摄影、褶皱、阴影或完整室内布景。
>
> `【文字】` 填法:要标题就写“画面顶部的大片留白区写手写中文标题,逐字为……;字像普通家长用粗黑笔写的,大小略不齐但准确清楚”;不要就写“不加任何文字”。

```
把随请求附带的参考图当作本画风的唯一主视觉锚点:新画首先要像同一个普通家庭用同一盒蜡笔、同一种手劲画出来;文字规则只帮助迁移到新内容,不得把人物修得比参考图更圆、更齐、更光滑。尤其继承参考图中蜡笔涂抹的起停、换向、交叉、重压、漏空和越界方式,而不只是套一层“蜡笔纹理”。只继承参考图的线条、五官、人物比例、蜡笔涂抹轨迹、留白和白底气质;不要复制参考图里的人物身份、服装、站位或情节。

最高优先级·涂抹门禁:绝不能用细、密、平行、等间距的斜线给衣服和物体铺色。必须像孩子把短蜡笔握得很笨,在同一个色块的不同位置分别粗粗乱蹭:一处横着来回,一处竖着划,一处突然改成斜线、回圈或交叉重压,中间直接停笔漏掉大片白纸。笔触有的很短、有的拖得很长,有的粗重结块、有的只擦过一下;方向切换没有整齐分区。涂色经常提前停在轮廓里面,也经常一把蹭过轮廓外面。宁可过乱、过空、过界,也不要整齐铺满。NO neat diagonal hatching. NO uniform coverage. NO repeated digital crayon texture.

一张普通家庭投稿感的亲子蜡笔故事卡,画在干净、明亮、接近纯白的平面纸底上。它不是纸张照片,不出现折痕、纸纤维特写、桌面、投影或做旧纹理;也不是数字儿童绘本、商业插画或 AI 蜡笔滤镜。

画面内容:【主体】。

构图:主体集中在画面下半部或中下部,上方保留大片安静留白;人物脚下最多一条歪歪的黑色地面线,背景只留 0-2 件讲清动作所必需的简单道具。不要完整房间、复杂家具、装饰性小物、漂亮透视或舞台化构图。

人物比例:成年人明显高于孩子,身体是略笨的长方块或简单筒形,四肢简化但动作清楚;孩子明显更矮,头只比成人相对大一点。手可以是圆钝小钩或短线,脚是扁扁的小黑鞋。每个人的头部外形、肩宽、躯干歪斜和腿长都要有自然差异,像逐个徒手画成,不能共享同一套标准骨架后只换发型衣服。允许肩膀高低不齐、左右不对称和关节连接不准,但禁止 Q 版大头、圆脸萌娃、火柴四肢、写实人体、精细手指和职业插画式动态。

脸部身份锁(每个人都必须遵守):两只很小的竖椭圆黑点眼,位置略不齐;小小的折线或弯钩鼻;一条极短的歪线嘴,可按情绪轻微上弯、下弯或张成小缺口;两团大小和深浅不完全相同的珊瑚红/粉红蜡笔乱涂圆腮红。默认不画眉毛,只有强情绪才允许一两道很短的歪线。禁止所有人复制同一张笑脸,也禁止眼白、虹膜、高光、大眼睛、睫毛、成形眉毛、写实眼睑、立体鼻梁、丰润嘴唇、渐变肤色和喷绘腮红。

线稿:普通大人用黑色蜡笔或勾线笔徒手画的细到中等粗轮廓,粗细和压力不均,边线会轻微抖动、歪斜、断开、出头;多数轮廓一两笔带过,只有少数犹豫处偶尔来回描。不同人物的抖动、歪斜和重复位置不能整齐同步。线条数量少,没有工整闭合、统一线宽、矢量圆角或粗重卡通描边;头发由交叉乱线、回头重压和局部白洞构成,不是顺滑发型块或整齐同向排线。

蜡笔涂抹轨迹(一级画风身份,不是后期纹理):像 5-8 岁孩子拿短蜡笔分段乱涂。大色块普遍只涂到一部分,白纸不是细小缝隙,而是一块块醒目的空洞。每个主要色块内部都能看到孩子中途停笔、从别处重新起笔、突然换方向和回头重压;横划、竖划、斜划、短弧、回勾、打圈和锯齿式来回摩擦同时出现,部分笔触相互交叉叠压。笔触必须粗钝、长短悬殊,不能变成细密的铅笔排线。密度会毫无规律地突然变重、突然变轻,紧挨着深色结块的地方可以直接漏成大片白纸。涂色边缘不跟随黑轮廓整齐收手:有的提前停下没碰到边,有的压过边界,有的在轮廓外留下孤立彩色划痕。不同人物、不同色块的方向、密度、断点和越界方式互不复制。肤色也只用很淡、零散且方向不一的桃色划痕,不能均匀铺脸。

涂抹硬性禁止:细密短斜线铺满色块、单一方向的平行斜线、等间距排线、规则交叉网纹、均匀覆盖、连续完整涂层、所有色块共用同一笔触方向、统一数字蜡笔刷纹理,以及用程序噪点冒充孩子乱涂。如果第一眼像给每个色块盖了同一个“蜡笔排线滤镜”,即判不合格。

配色:明快但不荧光的普通蜡笔基础色。单个人物通常只用 1-2 个衣着主色;多人家庭场景全画可以自然出现约 5-7 种颜色,例如橙棕、天蓝、草绿、粉红、芥末黄、灰色和浅桃肤色。不要强行压成四种颜色,不要每个人彩虹配色,不要低饱和灰雾滤镜。

整体判断:第一眼像普通家长逐个人画了略歪的黑线稿,再由孩子一小块一小块、断断续续地认真乱涂;有温度、有笨拙且不重复的小错误,人物保留各自年龄、情绪和身体差异,但内容与动作一眼能看懂。如果人物像同一个数字模板换装,或五官轮廓过度对称,或蜡笔笔触整页同向、等距、等密度,即判不合格。绝不精修、绝不规整、绝不商业萌化。
...
>
> 这是"小孩自己画的坏画"(偏插画/图形感)。要"像真蜡笔涂在纸上的照片、一眼真人手涂"请用 [#7 蜡笔实拍](#7-蜡笔实拍真儿童手涂纸张)。
...
## 5. MS Paint 烂涂鸦(the worse, the better)
...
>
> 和 [#2 蜡笔童涂](#2-蜡笔童涂5岁小孩坏画) 的区别:#2 是"小孩自己画的坏画"(偏插画);#7 是"一张真蜡笔纸的照片",命门在实拍纸感 + 强制露白(每块色露白约 40–50%) + 蜡质方向笔触 + 反数字滤镜(经 gpt-image 实测)。
...
> 和 [#12 暖光童画](#12-暖光童画动画概念暖绘)的区别:#12 是 Pixar vis-dev 气质(大眼大虹膜、青橙互补、暖金辉光);#14 眼睛是小点、配色更冷静克制、零光效,是"安静的北欧绘本",两者气质相反。
> 模板为已验证英文原文,占位符也填英文,不要转译。
...
> 和 [#13 北欧纸雕](#13-北欧纸雕paper-folk)同属"软 3D 渲染",区别:#13 是纸材质+民俗图案+大投影强立体;#15 是软胶潮玩+街头穿搭+柔光平底,气质一冷静手工一呆萌潮流。
> 模板为已验证英文原文,占位符也填英文,不要转译。
...
>
> 出身:Midjourney --sref 2344047981 的 gpt-image 复刻(2026-07-16 四张标杆图五轮逐张并排对照定稿:惊讶男孩/呆脸大叔/戴镜老爷爷/圆胖小鸟四种主体 × 橙/蓝两种底色全部验证,终版四张与标杆并排评分 94–96)。本质是"数码水粉动画概念立绘":满幅单色刷底 + 人物身后聚光晕 + 夸张比例大眼角色 + 软喷绘脸×干扫笔触,高级绘本 × 动画电影 vis-dev 气质。适合角色立绘、角色系列(跨张统一底色即成套)、i2v 动画锚图。
> 命门(五轮翻车教训,全部写死):**①背景笔触是三向走钢丝**——写重了(heavy mottling)出深色油画斑驳底(首轮翻车),写平了(mostly flat)出数字平涂(次轮小鸟翻车),不压饱和就出火焰橙底(四轮男孩偏差);唯一验证通过的表述是 "clearly visible loose scumbled dry-brush strokes + gentle tonal variation + matte and calm/muted + NOT fiery saturated";**②皮肤禁纹理**——脸和皮肤必须 airbrushed smooth 干净渐变,可见笔触只留在头发/皮毛/羽毛/衣服/背景;**③头发写羽化发簇**——"soft FEATHERED brush-stroke tufts, each tuft one wide soft feathered stroke",两个反向坑都要点名:写不够软出尖刺动漫发(首轮),只写 rounded masses 出卷花菜团(次轮),必须同时禁 "NOT razor-sharp anime spikes, NOT tight curly ringlets";**④眼睛要留眼白**——虹膜/瞳孔外必须写 visible white sclera,不写死成人角色会出无眼白的眯缝黑豆眼(三轮大叔翻车);**⑤身份特征=满幅涂满+聚光晕**——单色刷底涂满到边、人物身后一圈更亮的柔光,四边绝不露白纸;**⑥互补色排布**——全画只有一对互补色:蓝青主体×暖橙底,或暖橙主体×蓝底。
> 和 [#12 暖光童画](#12-暖光童画动画概念暖绘)同源(都是 MJ sref 动画 vis-dev 水粉的复刻),区别:#12 是"未画完的概念稿"(白纸留边+粉蓝奶黄碎笔背景+童画大虹膜),#16 是"画满的聚光立绘"(单色满幅底+聚光晕+虹膜正常留眼白,角色从萌娃到大叔小鸟全适配)。
> 模板为已验证英文原文,占位符也填英文,不要转译。
...
>
> 出身:Midjourney --sref 3865390274 的 gpt-image 复刻(2026-07-16 三张标杆图两轮对照定稿:蓝发丸子头对标图1、红帽墨镜单色系对标图3双双过局部级复核,另加男孩主体泛化验证)——"富有表现力的绘本角色 + 绘画质感 + 温暖手工感"。本质是"钢笔速写线稿 × 绘本淡彩":墨线定形、起稿线外露、发丝逐根勾,底下是干净透亮的柔和数码上色,水彩刷涂背景 + 奶白纸边毛刷框。适合角色立绘、故事绘本、头像、i2v 动画锚图。
> 命门(两轮翻车教训,五条都必须写死):**①上色**必须写"clean bright digital painting + NO 彩铅颗粒填色 + NO 画布纹",否则整张退化成灰扑扑的彩铅速写(首轮翻车);**②排线只做点缀**——腮红斜排线(脸颊+鼻梁)、帽子/衣服暗部交叉排线、背景少量干刷刮痕是本风格的签名细节,必须以"sparse deliberate accents in a darker shade of the local color"单独成段写进去;但禁止排线铺满色块(那是①的彩铅病)——"点缀排线"与"排线填色"一存一废是本配方的走钢丝处;**③线色随区域**——蓝发用深藏青线、红衣用深栗红线、皮肤用暖褐线,整体读作深褐黑,不是统一纯黑;**④背景与边框**——背景是"松散水彩刷涂+可见笔痕",不能死平也不能出细节云;边框必须"大块毛边矩形+四边平整奶白纸边+一两道白刷痕压进画面",写成模糊淡出就只剩羽化暗角;**⑤眼与发是身份特征**——虹膜几乎占满眼眶、只留眼角一点眼白;头发是"深色墨线逐根顺发流+浅色提亮丝两层"、轮廓外适量飞丝,且要写明"优雅、不是乱麻"(否则出满头乱线)。
> 和 [#12 暖光童画](#12-暖光童画动画概念暖绘)同属 MJ 绘本 sref 复刻,区别:#12 是水粉厚涂 vis-dev(几乎无线稿、头发画成大体积块、青橙互补锁死);#17 线稿主导(墨线是画面的骨架)、上色轻薄透亮、配色每图一套协调即可,气质是"速写手账页"而非"厚涂概念稿"。
> 模板为已验证英文原文,占位符也填英文,不要转译。填【配色】时顺手把 LINES 段里的线色示例改成与实际配色对应(如金发→deep umber lines on the blonde hair)。
...
LINES: every shape is defined by confident loose sketchy ink lines of slightly varying thickness; line color is keyed to each region — a much darker shade of the underlying local color (deep navy lines on blue hair, deep maroon lines on red fabric, warm sepia around the skin), overall reading as dark sepia-black; a few overlapping construction strokes are left visible but the drawing stays elegant, NOT a chaotic scribble mess; hair is drawn as smooth flowing individual strand lines following the hair volume, with a moderate number of fine whippy flyaway strands escaping the silhouette, plus a few lighter-tint painted highlight strands over the darker hair masses; clothing folds are a few loose quick line strokes.
ACCENT HATCHING (signature detail): sparse deliberate hatch strokes in a darker shade of the local color appear ONLY as accents — fine diagonal blush hatching on the cheeks and across the nose bridge, light cross-hatch shading in hat/clothing shadow areas, and a few faint scratchy dry-brush marks in the background wash; everything else stays smooth.
...
BACKGROUND: a loose atmospheric watercolor wash of 【背景色】, with visible soft brush streaks and gentle uneven mottling — painterly but low-detail, NO detailed scenery, NO detailed clouds.
...
>
> 和 [#14 北欧绘本水粉](#14-北欧绘本水粉nordic-storybook)的区别:#14 依赖全画纸纹牙口、干刷水粉颗粒、低饱和安静人物;#18 是平滑数码平涂、鲜明蓝橙、高对比几何大色块和更强的动作弧线。
>
> 模板为已验证英文原文,占位符也填英文,不要转译。
...
> 2026-07-13 经 Midjourney V7 标杆对照实测定稿(全过程见 `benchmarks/`)。适用对象:一切"画在纸上"的画风——#2/#3.1/#7 直接叠加;#10 用文末轻量版;#3/#8/#9 等非纸面画风不适用。
