...
>
> 唯一主视觉真源:`assets/style-1.2/anchor-family.png`。这张图的视觉判断优先于文字配方;文字只负责把它转译到新人物、新动作和新场景,不能另造一套更规整的审美。正式生产、连续故事或多页作品必须把它作为**纯画风参考**随每一张请求一起传入;只参考线条、五官、人物比例、蜡笔填色、留白和纸面,不得复制参考图中的家庭成员、站位、衣服或情节。参考图不可用时停止正式生产,不能改用业务项目自己的画风段落补救。
>
> 和 #1 / #1.1 的区别:#1 偏粗黑涂色页与纸面实拍,#1.1 偏低饱和四色克制;1.2 是明亮白底、普通大人歪线稿、孩子稀疏蜡笔填色的亲子投稿故事卡。人物可辨认但不精致,不是孩子从零画的火柴娃,也不是商业绘本萌娃。
>
> 命门:①脸锁成小竖椭圆黑点眼 + 小折线鼻 + 极短歪线嘴 + 珊瑚红圆形乱涂腮红,但嘴形和五官高低必须随情绪自然变化,不能人人复制同一张笑脸;②成人与孩子保持可辨认的高矮和身体比例,只轻微大头,绝不 Q 版巨头;③轮廓是细到中等粗的普通黑笔歪线,不能变成统一粗黑马克笔;④衣服和头发保留不规则大片露白与偶发越界,不能按统一比例机械执行;⑤同页人物不得复用同一头型、同一肩宽和同一身体骨架;⑥背景接近纯白且极简,不做纸张摄影、褶皱、阴影或完整室内布景。
>
> `【文字】` 填法:要标题就写“画面顶部的大片留白区写手写中文标题,逐字为……;字像普通家长用粗黑笔写的,大小略不齐但准确清楚”;不要就写“不加任何文字”。

```
把随请求附带的参考图当作本画风的唯一主视觉锚点:新画首先要像同一个普通家庭用同一盒蜡笔、同一种手劲画出来;文字规则只帮助迁移到新内容,不得把人物修得比参考图更圆、更齐、更光滑。只继承参考图的线条、五官、人物比例、蜡笔填色、留白和白底气质;不要复制参考图里的人物身份、服装、站位或情节。
...
线稿:普通大人用黑色蜡笔或勾线笔徒手画的细到中等粗轮廓,粗细和压力不均,边线会轻微抖动、歪斜、断开、出头;多数轮廓一两笔带过,只有少数犹豫处偶尔来回描。不同人物的抖动、歪斜和重复位置不能整齐同步。线条数量少,没有工整闭合、统一线宽、矢量圆角或粗重卡通描边;头发是几簇直接的黑色乱线,不是顺滑发型块。

填色:像 5-8 岁孩子拿蜡笔随手涂进大人线稿。衣服、裤子、头发等主要色块使用乱方向短笔画,有深线浅线、断续和轻重变化;各色块露白多少不同,总能看到几处自然越界,但位置、面积和力度不能按同一规则平均分配。肤色只是很淡、稀疏的桃色乱涂,仍保留白底;禁止整齐铺满、统一噪点、均匀留白、等量越界、柔滑混色、阴影、渐变或体积光。

配色:明快但不荧光的普通蜡笔基础色。单个人物通常只用 1-2 个衣着主色;多人家庭场景全画可以自然出现约 5-7 种颜色,例如橙棕、天蓝、草绿、粉红、芥末黄、灰色和浅桃肤色。不要强行压成四种颜色,不要每个人彩虹配色,不要低饱和灰雾滤镜。

整体判断:第一眼像普通家长逐个人画了略歪的黑线稿,再由孩子认真但没涂好的家庭投稿;有温度、有笨拙且不重复的小错误,人物保留各自年龄、情绪和身体差异,但内容与动作一眼能看懂。如果人物像同一个数字模板换装、五官和轮廓过度对称、涂色缺陷平均分布,即判不合格。绝不精修、绝不规整、绝不商业萌化。
