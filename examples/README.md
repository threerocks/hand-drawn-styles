...
![复古动画概念稿 妈妈立绘](12-retro-concept.png)

> 输入示例:「用复古动画概念稿画:一位年轻妈妈的半身立绘,黑色齐肩发,豆沙粉紫毛衣,温柔歪头笑」
> 命门:配色三件套(奶油暖底光晕+橙蓝互补+玫瑰腮红)+ 概念稿身份件(铅笔起稿线/试色色块/下缘干刷渐散)。双人样图见 `12-retro-concept-duo.png`。
> 最常踩的坑:画成标准美人脸、背景加环境细节、钴蓝锚点丢失。

```
一张1950年代美式中古动画概念设定稿风格的角色插画(mid-century Disney/UPA 血统的角色概念画),数字水粉厚涂,不是3D渲染、不是矢量插画、不是照片。
主体:一位年轻中国妈妈的半身立绘:黑色齐肩发,穿豆沙粉紫色毛衣,温柔地微微歪头笑,眼里有神采,玫瑰腮红;领口或袖口有一处钴蓝色细节做冷色锚点。
笔触(最重要):松散可见的水粉/干刷笔触,色块边缘毛化不封闭,厚涂颜料有干湿浓淡变化;轮廓外围隐约保留铅笔起稿线,画面一角留一两笔试色色块;画面下缘与外缘笔触渐散、干刷扫开融进纸白,保留概念稿的未完成感。
角色设计:动画角色设计而非写实美人——五官比例有戏剧化取舍、脸型有设计感,大眼睛带椭圆形高光,眉弓表情生动,必有玫瑰色腮红和暖肤色高光,宁可有个性不要标准漂亮脸。
